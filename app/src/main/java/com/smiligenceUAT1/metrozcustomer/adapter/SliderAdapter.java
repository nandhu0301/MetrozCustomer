...
public class SliderAdapter  extends SliderViewAdapter<SliderAdapter.SliderAdapterViewHolder> {
    ...
    private final List<AdvertisementDetails> mSliderItems;
    private Interface.ClickedListener clickedListener;
    //Constructor
    public SliderAdapter(Context context, ArrayList<AdvertisementDetails> sliderDataArrayList, Interface.ClickedListener clickedListener) {
    ...
    public void onBindViewHolder(SliderAdapterViewHolder viewHolder, final int position) {
        ...
        final AdvertisementDetails sliderItem = mSliderItems.get(position);
