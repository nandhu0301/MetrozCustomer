...
public class ViewFlipperAdapter1 extends BaseAdapter {

    private ArrayList<AdvertisementDetails> androidVersions;
    private Context mContext;
    private Interface1.ClickedListener clickedListener;


    public ViewFlipperAdapter1(Context context, ArrayList<AdvertisementDetails> androidVersions, Interface1.ClickedListener clickedListener) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (version.getAdvertisingStoreList()!=null)
                {
                    ...
                    {
                        clickedListener.onPictureClicked1(position);
                    }
                }
